...
import 'package:toktik/infraestructure/reposiories/video_posts_repository_impl.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        //..loadNextPage <- Esto es un operador de cascada para hacer diferentes cosas una tras otra con una misma raiz
